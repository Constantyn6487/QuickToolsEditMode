...
updater.addon = "quicktoolseditmode"
...
class AddonUpdaterInstallPopup(bpy.types.Operator):
    ...
    bl_idname = updater.addon + "quicktoolseditmode.updater_install_popup"
...
def register(bl_info):
    ...
    updater.user = "Constantyn6487" #<‑‑ заменил имя пользователя

    # Choose your own repository, must match git name for GitHUb and Bitbucket,
    # for GitLab use project ID (numbers only).
    updater.repo = "QuickToolsEditMode" #<‑‑ заменил репозиторий

    # updater.addon = # define at top of module, MUST be done first

    # Website for manual addon download, optional but recommended to set.
    updater.website = "https://github.com/Constantyn6487/ChocoPie/" #<‑‑ заменил (веб сайт) сделал чтобы вел на репозиторий гитхаба т.к. нет сайта.
    ...
    updater.current_version = bl_info["version"] #<‑‑ заменил видимо надо в каждый со своей версией.
